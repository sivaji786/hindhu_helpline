import svgPaths from "./svg-16tdyvlj15";
...
function Title() {
  return (
    <div className="content-stretch flex flex-col items-center leading-[0] not-italic relative shrink-0 text-center w-full" data-name="Title">
      ...
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[30px] relative shrink-0 text-[#797676] text-[0px] text-[16px] w-full">
        <p className="mb-0">Enter your details to create an account</p>
        <p className="font-['Poppins:Bold',sans-serif] not-italic">Referred by : Name</p>
      </div>
    </div>
  );
}
...
function LabelTextContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic opacity-[0.38] relative shrink-0 text-[#1d1b20] text-[20px]">Mobile number*</p>
    </div>
  );
}
...
function StateLayer() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[4px] shrink-0 w-full" data-name="State-layer">
      <div aria-hidden="true" className="absolute border border-[rgba(29,27,32,0.12)] border-solid inset-[-0.5px] pointer-events-none rounded-[4.5px]" />
...
function TextField() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="Text field">
      <StateLayer />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col h-[56px] items-start relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="Text field - Mobile number">
      <div className="absolute inset-0 opacity-[0.04] rounded-[4px]" data-name="disabled-state-color">
        <div aria-hidden="true" className="absolute border border-[#1d1b20] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
      <TextField />
    </div>
  );
...
function RememberMe() {
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow items-center min-h-px min-w-px relative shrink-0" data-name="remember me">
      ...
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#797676] text-[16px] text-nowrap">
        <p className="leading-[30px]">Use the same number for WhatsApp?</p>
      </div>
    </div>
  );
}

function UseTheSameNumberForWhatsApp() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Use the same number for WhatsApp?">
      <RememberMe />
    </div>
  );
}
...
function LabelTextContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">WhatsApp number</p>
    </div>
  );
}
...
function TextFieldMobileNumber1() {
  return (
    <div className="content-stretch flex flex-col h-[56px] items-start relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="Text field - Mobile number">
      <TextField1 />
    </div>
...
function LabelTextContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">Email</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <TextFieldPassword />
      <p className="font-['Poppins:Regular',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#adaaaa] text-[0px] text-[14px] w-full">
        *<span className="font-['Poppins:Bold',sans-serif]">Note</span>
        <span>{`: For added security, a one-time `}</span>password<span>{` (OTP) will be sent to your mobile number. Please use it to verify your account.`}</span>
      </p>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[10px] relative size-full">
          <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[0px] text-center text-nowrap text-white">
            <p className="font-['Poppins:Bold',sans-serif] leading-[30px] text-[20px]">Get OTP</p>
          </div>
        </div>
      </div>
    </div>
...
function Form1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] h-[1117px] items-center justify-center left-[calc(58.33%-12px)] px-[150px] py-[368px] top-0 w-[732px]" data-name="Form">
      <Logo />
      <FormContainer />
    </div>
  );
...
export default function SignupMobileEmail() {
  return (
    <div className="bg-[#fff6ed] relative size-full" data-name="Signup - Mobile & Email">
      <Form1 />
      <HeroImage />
    </div>
  );
