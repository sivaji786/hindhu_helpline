import svgPaths from "./svg-0wamemja2n";
...
export default function SignupPersonalDetailsThroughReferral() {
  return (
    <div className="bg-[#fff6ed] relative size-full" data-name="Signup - Personal Details - Through Referral">
      <Form1 />
      <HeroImage />
    </div>
  );
