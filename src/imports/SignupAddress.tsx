...
function LabelTextContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">State*</p>
    </div>
  );
}
...
function LabelTextContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">District*</p>
    </div>
  );
}
...
function LabelTextContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">Mandal*</p>
    </div>
  );
}
...
function LabelTextContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">City*</p>
    </div>
  );
}
...
function TextFieldMartialStatus3() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex flex-col h-[56px] items-start ml-0 mt-0 relative rounded-tl-[4px] rounded-tr-[4px] w-[432px]" data-name="Text field - Martial status">
      <TextField3 />
    </div>
...
function LabelTextContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">Zipcode*</p>
    </div>
  );
}
...
function TextFieldMartialStatus4() {
  return (
...
function LabelTextContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Label text container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[30px] min-h-px min-w-px not-italic relative shrink-0 text-[#797676] text-[20px]">Address*</p>
    </div>
  );
}
...
function TextFieldMartialStatus5() {
  return (
    <div className="content-stretch flex flex-col h-[56px] items-start relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="Text field - Martial status">
      <TextField5 />
    </div>
...
function Form() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start relative shrink-0 w-full" data-name="Form">
      ...
      <BloodGroup1 />
      <BloodGroup2 />
      <TextFieldMartialStatus4 />
      <TextFieldMartialStatus5 />
      <Login />
      <Frame1 />
    </div>
  );
...
export default function SignupAddress() {
  return (
    <div className="bg-[#fff6ed] relative size-full" data-name="Signup - Address">
      <Form1 />
      <HeroImage />
    </div>
  );
